...
- More fun things you can do with HTML
    ...
    ```
    groups the `h3` heading and the table as one section, called __education__, for targeting by CSS or other HTML elements


        - If we wanted to link directly to the __education__ section, we could use `href="#education"` in our `<a>` tags
